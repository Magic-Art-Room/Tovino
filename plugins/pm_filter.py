    ...
    if query.data.startswith("file"):
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                caption=f'<b>Hey 👋 {query.from_user.mention}</b> 😍\n\n<code>{title}</code>\n\n⚠️ <i>This file will be deleted from here within 5-10 minute due to Copyright ... !!!</i>\n\n<i>© Bot Managed By @ArkBotz</i>\n\n<i><b>⚡ Powered by {query.message.chat.title}</b></i>',
                protect_content=True if ident == "filep" else False 
            )
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/+tvNfPK-SwrpiYTI1')
                        ]
                    ]
                )
            )
